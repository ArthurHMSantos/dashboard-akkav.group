...
st.markdown("<h1 style='text-align: center;'>BankChurners Dashboard</h1> <p>Utilize o menu lateral para filtrar o dataframe.</p>", unsafe_allow_html=True)
st.sidebar.title("Filtrar Dataframe")

def filter_dataframe(df: pd.DataFrame) -> pd.DataFrame:
    """Filter a dataframe using the sidebar."""
